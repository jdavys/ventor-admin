<h2 class="page-header" style="margin-top:0;">Bienvenido <small class="pull-right">Manual de Usuario</small></h2>
<p>Este es el <b>manual de usuario</b> que te servira para conocer el funcionamiento de <b>Ventor</b>.</p>
<div class="row">
	<div class="col-md-6">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
		  ...
		  <ul class="list-group">
			<li class="list-group-item">- <a target="blank" href="http://www.anexsoft.com">Web Oficial y Centro de Compra</a></li>
			<li class="list-group-item">- <a href="mailto:soporte@anexsoft.com">Correo para Sugerencia, Bug o Reclamo</a></li>
	      </ul>
		</div>
	</div>
	<div class="col-md-12">
		<div class="panel panel-default">
		  <div class="panel-heading">Caracteristicas de la Versión Actual: <b class="pull-right">VENTOR <?php echo $v; ?></b></div>
		  <ul class="list-group">
			...
			<li class="list-group-item">Nuevos roles en los <b>tipos de usuario</b>.</li>
	      </ul>
		</div>
	</div>
	<div class="col-md-12">
		<iframe width="100%" height="600" frameborder="0" allowfullscreen="" src="//www.youtube.com/embed/lSC3rqumV-E"></iframe>
	</div>
</div>