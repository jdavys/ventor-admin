...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<div title="Sub Total" class="absolute" id="SubTotal" class="text-right" style="left:440px;top:410px;"><?php echo number_format($comprobante->SubTotal, 2); ?></div>
			<div title="Total a Pagar" class="absolute" id="total" class="text-right" style="left:540px;top:410px;"><?php echo number_format($comprobante->Total, 2); ?></div>
			<div title="Impuesto Total"  class="absolute" id="IvaTotal" class="text-right" style="left:400px;top:410px;"><?php echo $comprobante->ComprobanteTipo_id == 3 ? number_format($comprobante->IvaTotal, 2) : ''; ?></div>
			...
			<div title="Detalle del Comprobante"  style="left:90px;top:192px;" class="absolute" id="detalle">
				...
				<div <?php echo 'style="width:74px;"'; ?> class="row">
					<?php foreach($comprobante->Detalle as $k => $c):?>
						<div class="text-right"><?php echo number_format($c->PrecioUnitario, 2); ?></div>
					<?php endforeach;?>
				</div>
				
				<div <?php echo 'style="width:74px;"'; ?> class="row">
					<?php foreach($comprobante->Detalle as $k => $c):?>
						<div class="text-right"><?php echo number_format($c->PrecioUnitario * $c->Cantidad, 2); ?></div>
					<?php endforeach;?>
				</div>
			</div>		
		</div>
